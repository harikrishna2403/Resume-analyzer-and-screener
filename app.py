...
GOOGLE_CLIENT_ID = "240628251126-rr1pbh14aavih7r6gqh7ai0is5a91qb8.apps.googleusercontent.com"
...
app.config['MONGO_URI']= 'mongodb+srv://admin:admin@cluster0.b0plv7b.mongodb.net/SKILLSPOTTER'
